        ...
        for message in messages:
            ...
            if isinstance(message, StartChattingMessage):
                ...
                response_messages.append(TextMessage(
                    ...
                    body="Hey {}, whats up?".format(user.first_name),
            ...
            # Check if the user has sent a text message.
                ...
                if message_body.split()[0] in ["hi", "hello","yo","sup"]:
                    response_messages.append(TextMessage(
                        to=message.from_user,
                        chat_id=message.chat_id,
...
if __name__ == "__main__":
    """ Main program """
    kik = KikApi('cipherbot', '79c5994e-971d-4837-8e8e-c8806435b7bb')
    ...
    kik.set_configuration(Configuration(webhook='https://kikproject-cloned-arifaulakh.c9users.io/incoming'))
    app = KikBot(kik, __name__)
    port = os.getenv("PORT", "8080")
    ip = os.getenv("IP", "0.0.0.0")
    app.run(port=int(port), host=ip, debug=True)
